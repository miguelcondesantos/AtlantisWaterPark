...
const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!cliente.nome || !cliente.nomeSocial || !cliente.dataNascimento || !cliente.telefones.every(tel => tel.numero) || !cliente.enderecos.every(endereco => endereco.rua && endereco.bairro && endereco.cidade && endereco.estado && endereco.pais && endereco.codigoPostal) || !cliente.rg || !cliente.cpf || !cliente.passaporte) {
